...
const BannerOnePage = () => {
  ...
  return (
    <>
                    ...
                    <div className="content-box">
                      <div className="content">
                        <div className="inner text-center">
                          <div className="sub-title1">{subtitle}</div>
                          <h1>
                            Stvaramo <br /> <span>{title}</span>
                          </h1>
                          ...
                          <div className="link-box">
                            <Link href="" legacyBehavior>
                              <a className="theme-btn btn-style-one">
                                ...
                                <span className="btn-title">Više o nama</span>
                              </a>
                            </Link>
      ...
      <VideoModal isOpen={isOpen} setOpen={setOpen} id={"0kpiqZhj_nQ"} />
    </>
  );
};
