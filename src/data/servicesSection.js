const services = [
  {
    ...
    text: "U organizaciju događaja ulažemo naporan rad i mnogo strpljenja kako bismo klijentima isporučili događaj po očekivanjima.",
  },
  {
    id: 2,
    icon: "flaticon-digital",
    title: "Organizacija muzičkih događaja",
    text: "Organizacija visoko-kvalitetnih festivala i koncerata koji nude nezaboravna iskustvo i zabavu.",
  },
  {
    id: 3,
    icon: "flaticon-business1",
    title: "Korporativni događaji",
    text: "Stvaramo najbolje uslove za konferencije i sajmove u biznis svijetu, kako bi što lakše predstavljali vaše proizvode i biznis.",
  },
  {
    id: 4,
    icon: "flaticon-creativity",
    title: "Godišnjice i proslave",
    text: "Organizujemo sve vrste privatnih proslava za vaše partnere ili prijatelje, zajedno možemo stvoriti nezaboravne momente.",
  },
];
