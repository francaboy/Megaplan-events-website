...
export const footer = { year: new Date().getFullYear(), author: "Srdjan" };
...
export const mainFooter = {
  ...
  text: "Dobrodošli u svijet nevjerovatnih događaja! Bavimo se organizacijom spektakularnih događaja koji će vas ostaviti bez daha. ",
